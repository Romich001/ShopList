...
import com.romanvoytyuk.shoplist.databinding.FragmentShopItemBinding
...
class ShopItemFragment : Fragment() {
    ...
    private fun setTextChangeListeners() {
        ...
        binding.itemNameInputField.addTextChangedListener(object : TextWatcher {
        ...
        binding.itemPriceInputField.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
    ...
    private fun launchAddMode() {
        binding.buttonSave.setOnClickListener {
            viewModel.addShopItem(
                binding.itemNameInputField.text.toString(),
                binding.itemPriceInputField.text.toString()
            )
        }
    }
